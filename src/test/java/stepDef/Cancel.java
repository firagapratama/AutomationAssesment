...
public class Cancel extends env_target {
    @Given("User is on leave menu")
    public void userIsOnLeaveMenu() {
    ...
    @And("User click my leave menu")
    public void userClickMyLeaveMenu() {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"app\"]/div[1]/div[1]/header/div[1]/div[1]/span/h6"))
        );
    ...
    @Then("User click cancel apply")
    public void userClickCancelApply() {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[1]/div[1]/div[1]/h5"))
        );

        WebElement buttonSelect = driver.findElement(By.className("oxd-select-text-input"));
        buttonSelect.click();
        driver.close();
    }
}
